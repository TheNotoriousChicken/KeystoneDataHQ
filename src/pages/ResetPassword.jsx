                        ...
                        {status === 'success' ? (
                            ...
                            >
                                ...
                                <button
                                    ...
                                    className="w-full bg-brand-primary hover:bg-brand-primary-hover text-white py-3.5 rounded-md font-bold transition-all mt-4"
                                >
                                    Sign In Now
                                </button>
                            </motion.div>
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        <input
                                            ...
                                            minLength={8}
                                            placeholder="••••••••"
                                            className="w-full bg-[#050505] border border-brand-border rounded-md px-4 py-3 pr-12 text-white placeholder-brand-muted/50 focus:outline-none focus:border-brand-primary focus:ring-1 focus:ring-brand-primary transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                                        />
                                        <button
                                            type="button"
